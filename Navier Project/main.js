	...
	var verbose = 1;          /* Verbosity level */
    var xlength = 22.0;     /* Width of simulated domain */
    var ylength = 4.1;      /* Height of simulated domain */
    var imax = 330;           /* Number of cells horizontally */
    var jmax = 60;           /* Number of cells vertically */

    var outname;  
    var output = 0;
    var output_frequency = 0;
    var t_end = 40; //2.1       /* Simulation runtime */

    var del_t = 0.003;      /* Duration of each timestep */
    var tau = 0.5;          /* Safety factor for timestep control */

    var itermax = 10;        /* Maximum number of iterations in SOR */
    var eps = 0.001;        /* Stopping error threshold for SOR */
    var omega = 1.7;        /* Relaxation parameter for SOR */
    var gamma = 0.9;        /* Upwind differencing factor in PDE
                                 discretisation */

    var Re = 150.0;         /* Reynolds number */
    var ui = 1.0;           /* Initial X velocity */
    var vi = 0.13;           /* Initial Y velocity */
	

    var t, delx, dely;
    var  i, j, itersor = 0, ifluid = 0, ibound = 0;
    var res;
    
    var flag; 
    var init_case, iters = 0;
    var show_help = 0, show_usage = 0, show_version = 0;
